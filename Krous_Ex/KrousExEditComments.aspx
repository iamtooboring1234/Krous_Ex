<%@ Page Title="" Language="C#" MasterPageFile="~/AllUserSite.Master" AutoEventWireup="true" CodeBehind="KrousExEditComments.aspx.cs" Inherits="Krous_Ex.KrousExEditComments" %>
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group pdForm">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="txtReplyContent" TextMode="MultiLine" Rows="20" runat="server" CssClass="form-control" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-md-10 text-right">
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" ConfirmText="Are you sure to EDIT this comments?" TargetControlID="btnYes" />
